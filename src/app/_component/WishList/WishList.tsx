...
function WishList() {
  ...
  return (
    ...
    :<>
    {
        wishData?.length?<div className="w-3/4 mx-auto my-10">

           <div className='relative mb-0'>
            <p className='text-center text-2xl mt-15 '><i className="fa-regular fa-heart"></i>WISHLIST</p>
            <p className='relative bottom-4 left-1/2 font-bold text-gray-600/30  z-0 -translate-1/2 text-8xl w-fit'>W</p>
        </div>
                ...
                <td className="px-6 py-4">
                    {
                        ...
                        <p><span className=" line-through text-gray-600">{product.priceAfterDiscount} EGP</span> {product.price} EGP</p>
                        :
                        <p>{product.price} EGP</p>
                    }
                </td>
                <td className="px-6 py-4 t flex flex-row justify-center items-center gap-2 ">
                    <Link className="border-cyan-800 flex justify-center items-center border-1 px-1 py-4" href={`/products/${product._id}`}>
                       <i className="fa text-cyan-700 fa-eye fa-xl cursor-pointer"></i>
                </Link>
                 <AddToCartBtn id={product._id}/>
                  <button className="border-cyan-800 flex justify-center items-center border-1 px-1 py-4" onClick={()=>{DeleteIteminWihList(product._id)}}>
                ...
                <div key={product._id} className="col-span-12 lg:col-span-6 p-3 lg:hidden flex justify-center items-center">
                   ...
                   <div>
                      ...
                      <div className="flex gap-2">
                         ...
                         <AddToCartBtn id={product._id}/>
                        <button className=" flex justify-center items-center " onClick={()=>{DeleteIteminWihList(product._id)}}>
