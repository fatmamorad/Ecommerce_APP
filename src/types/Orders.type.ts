...
export enum Title {
    WomanBordeauxLongSleeveBlouseBORDEAUX = "Woman Bordeaux Long Sleeve Blouse BORDEAUX",
    WomanBrownLongSleeveTunicLTCAMEL = "Woman Brown Long Sleeve Tunic LT.CAMEL",
